...
export function CheckoutPage() {
  ...
  const onSubmit = async (values: CheckoutValues) => {
    ...
    if (!selectedAddressId) {
      showErrorToast("يرجى إضافة عنوان شحن واختياره قبل إتمام الطلب.");
      return;
    }
