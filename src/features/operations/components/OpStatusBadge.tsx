...
const STATUS_MAP: Record<string, { label: string; cls: string }> = {
  ...
  rejected:     { label: 'مرفوض',      cls: 'bg-red-100 text-red-800 ring-1 ring-red-300 dark:bg-red-900/40 dark:text-red-200 dark:ring-red-700/60' },
  ...
  in_production:{ label: 'قيد التصنيع', cls: 'bg-blue-100 text-blue-800 ring-1 ring-blue-300 dark:bg-blue-900/40 dark:text-blue-200 dark:ring-blue-700/60' },
  ...
  pending_approval: { label: 'بانتظار الموافقة', cls: 'bg-amber-100 text-amber-800 ring-1 ring-amber-300' },
  new:           { label: 'جديد', cls: 'bg-sky-100 text-sky-800 ring-1 ring-sky-300' },
  in_review:    { label: 'قيد المراجعة', cls: 'bg-blue-100 text-blue-800 ring-1 ring-blue-300' },
  quoted:       { label: 'تم التسعير', cls: 'bg-violet-100 text-violet-800 ring-1 ring-violet-300' },
  converted:    { label: 'تم التحويل', cls: 'bg-emerald-100 text-emerald-800 ring-1 ring-emerald-300' },
  // ── Payments ────────────────────────────────────────────────────────
  ...
  unpaid:       { label: 'غير مدفوع', cls: 'bg-amber-100 text-amber-800 ring-1 ring-amber-300' },
  // ── Inventory ───────────────────────────────────────────────────────
  in_stock:     { label: 'متوفر',      cls: 'bg-emerald-100 text-emerald-800 ring-1 ring-emerald-300 dark:bg-emerald-900/40 dark:text-emerald-200 dark:ring-emerald-700/60' },
  ...
  active:        { label: 'نشط',           cls: 'bg-emerald-100 text-emerald-800 ring-1 ring-emerald-300' },
  inactive:      { label: 'غير نشط',       cls: 'bg-gray-100 text-gray-700 ring-1 ring-gray-300' },
